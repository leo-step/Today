...
function PrinceNewsTable(props) {
  ...
  const rows = articles.map((article, i) => {
    return <tr className={i === articles.length-1 ? 'divider no-divider' : 'divider'} 
          ...
          <tr className="centered mediumfont">
            <td>
              <Button style={{
                ...
                onClick={() => {props.switchTo("street")}}>&lsaquo;&nbsp;Street</Button>
            </td>
            <td style={{width: "100%"}}>
            ...
            <td>
              <Button style={{
                ...
                onClick={() => {props.switchTo("street")}}>Street&nbsp;&rsaquo;</Button>
            </td>
          </tr>
          {rows}
